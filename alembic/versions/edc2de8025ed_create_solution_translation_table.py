"""create solution translation table
...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_solution_translation_solution_id", 'solution_translations', 'solutions',
                        ["solution_id"], ["id"], ondelete='CASCADE', onupdate='CASCADE')

def downgrade() -> None:
    op.drop_table('solution_translations')